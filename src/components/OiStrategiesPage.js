  ...
  return <section className="section" style={{ marginTop: 4 }}>
    ...
    <div className="grid grid-4" style={{ marginTop: 14 }}>
      ...
      <Metric label="MAX PAIN" value={price(market?.max_pain)} tone="var(--accent-yellow)" />
          {preview.metrics.broker_margin_required ? `Dhan margin required ${money(preview.metrics.broker_margin_required)}` : `Dhan margin unavailable; payoff estimate ${money(preview.metrics.margin_required)}`}
    </div>
